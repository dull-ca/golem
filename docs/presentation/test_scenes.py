...
WORD_BUDGET_CEILINGS: dict[str, tuple[int, str]] = {
    ...
    "golem/grading-goals-1-to-3": (126, "four graded claims, each with its goal number, its verdict word and the evidence behind it, and goal 1's two scoped exceptions named twice over -- once on a chip and once in the sentence"),
